          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative">
                <img src="/lovable-uploads/0722d406-a9c0-42cc-9706-36d5673b317e.png" alt="Saliza Seródio aplicando tratamento" className="w-full h-[400px] md:h-[500px] object-cover rounded-lg elegant-shadow" />
              </div>
            </div>
            
            {/* Content */}
            <div className="order-1 lg:order-2">
              <blockquote className="text-lg md:text-xl lg:text-2xl font-body text-foreground mb-6 leading-relaxed">"Há 20 anos descobri que nossas mãos têm o poder de despertar o que as máquinas não alcançam. Cada mulher é única, cada corpo conta uma história. Por isso desenvolvemos um método que transforma de verdade: você sai mais leve na primeira sessão e descobre que a mudança externa desperta algo muito maior dentro de você. E agora é a vez de Campinas viver essa transformação."</blockquote>
