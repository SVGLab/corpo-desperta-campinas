  ...
  return <section className="relative w-full">
      ...
      <div className="relative w-full max-w-[1920px] mx-auto">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 sm:px-6 lg:px-8 pt-40 sm:pt-60 md:pt-80">
          {/* CTA Button */}
          <Button variant="cta" size="xl" onClick={() => window.open('https://api.whatsapp.com/send/?phone=%2B5532999171361&text=Oi!+Vi+que+a+Corpo+SA+chegou+em+Campinas!+Quero+agendar+minha+avaliação+gratuita', '_blank')} className="fixed bottom-6 right-6 z-50 shadow-2xl animate-pulse hover:animate-none">
            QUERO DESPERTAR!
          </Button>
        </div>
      </div>
